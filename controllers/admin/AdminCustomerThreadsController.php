...
class AdminCustomerThreadsControllerCore extends AdminController
{
    public function __construct()
    {
        ...
        $this->fields_list = [
            ...
            'messages' => [
                ...
                'tmpTableFilter' => true,
                'maxlength' => 40,
                // added callback to decode all messages with html_entity_decode
                'callback' => 'decodeMsg',
            ],
            'private' => [
    ...
    public function renderView()
    {
        ...
        foreach ($messages as $key => $mess) {
            // fix greek chars
            $messsages[$key]['message'] = html_entity_decode($messages[$key]['message'], ENT_QUOTES, 'UTF-8');
            // end fix
            if ($mess['id_employee']) {
        ...
        // fix greek chars
        $first_message['message'] = html_entity_decode($first_message['message'], ENT_QUOTES, 'UTF-8');
        // end fix
        $this->tpl_view_vars = [
    ...
    // have added this extra function to call it from callback
    public function decodeMsg($value, $msg)
    {
